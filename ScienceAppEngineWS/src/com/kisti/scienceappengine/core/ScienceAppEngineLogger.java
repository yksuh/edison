...
/*****
 * Logger (extension) class for ScienceAppEngine logging
 * @author Young-Kyoon Suh
 */
public class ScienceAppEngineLogger extends Logger{
	/***
    ...
    /***
     * Constructor for ScienceAppEngine logger
     * @param name
     */
    public ScienceAppEngineLogger(String loggerName) {
    	super(loggerName);
...
//    	_logger.setLevel(Level.DEBUG);
    ...
    /***
     * Get ScienceAppEngine logger's name
     * @return _name
     */
    public String getScienceAppEngineLoggerName(){
    	return _name;
    }
    /***
     ...
     * 
     */
    public void setScienceAppEngineLoggerName(String fileName) {
    	_name = fileName;
    }
    /***
     * Return the current logger
     * @return ScienceAppEngine logger
     */
    public static Logger getScienceAppEngineLogger(String loggerName){
    	return _logger;
    }
    /****
     ...
     */
    public void setScienceAppEngineAppender(String hostName, String loggingTime, String appName, String logFileName) throws IOException{
...
//    	if(appName.equalsIgnoreCase(Constants.ScienceAppEngine_OBSERVER)){
////        	String extraAppName = MetaData.ScienceAppEngine_LOG_DIR_NAME + File.separator + "salvo.jesus.graph.visual.layout.LayeredTreeLayout";
//        	String extraAppName = "salvo.jesus.graph.visual.layout.LayeredTreeLayout";
//        	logFileName = Constants.ScienceAppEngine_LOG_DIR_NAME + File.separator
...
//        	
////        	extraAppName = MetaData.ScienceAppEngine_LOG_DIR_NAME + File.separator + "salvo.jesus.graph.visual.layout.Grid";
...
//        	
////        	extraAppName = MetaData.ScienceAppEngine_LOG_DIR_NAME + File.separator + "salvo.jesus.graph.visual.layout.AbstractGridLayout";
